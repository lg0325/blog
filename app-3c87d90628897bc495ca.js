(self["webpackChunkgatsby_starter_blog"] = self["webpackChunkgatsby_starter_blog"] || []).push([[143],{
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-index-js":()=>Promise.all(/* import() | component---src-pages-index-js */[__webpack_require__.e(84), __webpack_require__.e(678)]).then(__webpack_require__.bind(__webpack_require__, 6558)),"component---src-pages-using-typescript-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-using-typescript-tsx */ 970).then(__webpack_require__.bind(__webpack_require__, 8619)),"component---src-templates-blog-post-js":()=>Promise.all(/* import() | component---src-templates-blog-post-js */[__webpack_require__.e(84), __webpack_require__.e(989)]).then(__webpack_require__.bind(__webpack_require__, 4982))};
...
module.exports=[{plugin:__webpack_require__(2154),options:{"plugins":[],"maxWidth":630,"linkImagesToOriginal":true,"showCaptions":false,"markdownCaptions":false,"backgroundColor":"white","quality":50,"withWebp":false,"withAvif":false,"loading":"lazy","decoding":"async","disableBgImageOnAlpha":false,"disableBgImage":false}},{plugin:__webpack_require__(9608),options:{"plugins":[],"name":"Gatsby Starter Blog","short_name":"Gatsby","start_url":"/blog","background_color":"#ffffff","display":"minimal-ui","icon":"src/images/gatsby-icon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"4a9773549091c227cd2eb82ccd9c5e3a"}},{plugin:__webpack_require__(7420),options:{"plugins":[]}},{plugin:__webpack_require__(4094),options:{"plugins":[]}}];
...
const trimmedPathname=(0,strip_prefix/* default */.Z)(pathname,decodeURIComponent("/blog"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet("/blog"+"/page-data/sq/d/"+staticQueryHash+".json").then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error("We couldn't load \""+"/blog"+"/page-data/sq/d/"+staticQueryHash+".json\"");});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(_ref=>{let{staticQueryHash,jsonPayload}=_ref;staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromises,staticQueryBatchPromise]).then(_ref2=>{let[pageResources,staticQueryResults]=_ref2;let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter/* default */.Z.emit("onPostLoadPageResources",{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
if(pagePath&&"/blog"+pagePath!==browserLoc.pathname+(pagePath.includes("?")?browserLoc.search:"")&&!(production_app_loader.findMatchPath((0,strip_prefix/* default */.Z)(browserLoc.pathname,"/blog"))||pagePath.match(/^\/(404|500)(\/?|.html)$/)||pagePath.match(/^\/offline-plugin-app-shell-fallback\/?$/))){(0,index_modern.navigate)("/blog"+pagePath+(!pagePath.includes("?")?browserLoc.search:"")+browserLoc.hash,{replace:true});}// It's possible that sessionStorage can throw an exception if access is not granted, see https://github.com/gatsbyjs/gatsby/issues/34512
...
if(window.location.protocol!=="https:"&&window.location.hostname!=="localhost"){console.error("Service workers can only be used over HTTPS, or on localhost for development");}else if("serviceWorker"in navigator){navigator.serviceWorker.register("/blog"+"/sw.js").then(function(reg){reg.addEventListener("updatefound",()=>{(0,_api_runner_browser__WEBPACK_IMPORTED_MODULE_0__/* .apiRunner */ .h)("onServiceWorkerUpdateFound",{serviceWorker:reg});// The updatefound event implies that reg.installing is set; see
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   c4: function() { return /* binding */ g; },
/* harmony export */   cP: function() { return /* binding */ a; },
/* harmony export */   dq: function() { return /* binding */ f; },
/* harmony export */   mc: function() { return /* binding */ v; },
...
/******/ __webpack_require__.O(0, [774,532], function() { return __webpack_exec__(5824); });
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ }
]);
//# sourceMappingURL=app-3c87d90628897bc495ca.js.map